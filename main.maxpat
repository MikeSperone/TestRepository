...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 323.0, 293.5, 125.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 119.0, 424.0, 62.0, 20.0 ],
					"text" : "toconsole"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 185.0, 453.0, 52.0, 33.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 162.0, 453.0, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 119.0, 517.0, 578.5, 35.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.0, 483.0, 32.5, 18.0 ],
					"text" : "set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 186.0, 37.0, 18.0 ],
					"text" : "add ."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 119.0, 324.0, 49.0, 20.0 ],
					"text" : "commit"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 425.0, 175.0, 77.0, 18.0 ],
					"text" : "pull --rebase"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 17.0, 136.0, 529.0, 20.0 ],
					"text" : "sel 0 1 2 3 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 323.0, 239.0, 59.0, 20.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 323.0, 204.5, 97.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 323.0, 175.0, 37.0, 18.0 ],
					"text" : "push"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 236.0, 374.0, 60.0, 20.0 ],
					"text" : "print cmd"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 323.0, 374.0, 35.0, 20.0 ],
					"text" : "shell"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 221.0, 175.0, 43.0, 18.0 ],
					"text" : "status"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 323.0, 424.0, 70.0, 20.0 ],
					"text" : "print stdout"
				}
...
, 			{
				"box" : 				{
					...
					"outputmode" : 1,
					"parameter_enable" : 0,
					"patching_rect" : [ 119.0, 272.5, 167.0, 41.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 129.0, 226.0, 301.0, 41.0 ],
					"text" : "abstract console code to toconsole"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 434.5, 229.5, 332.5, 229.5 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 128.5, 353.25, 332.5, 353.25 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 128.5, 353.25, 245.5, 353.25 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 332.5, 407.0, 128.5, 407.0 ],
					"source" : [ "obj-56", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 171.5, 508.0, 128.5, 508.0 ],
					"source" : [ "obj-57", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 332.5, 267.25, 332.5, 267.25 ],
					"source" : [ "obj-75", 0 ]
				}
